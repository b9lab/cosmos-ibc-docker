...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/leaderboard/leaderboard/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryParamsResponse, RpcStatus>({
      path: `/leaderboard/leaderboard/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/leaderboard/leaderboard/player_info
   */
  queryPlayerInfoAll = (
    query?: {
    ...
    this.request<LeaderboardQueryAllPlayerInfoResponse, RpcStatus>({
      path: `/leaderboard/leaderboard/player_info`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
