...
import LeaderboardLeaderboardLeaderboard from './leaderboard/leaderboard.leaderboard'
...
export default { 
  ...
  LeaderboardLeaderboardLeaderboard: load(LeaderboardLeaderboardLeaderboard, 'leaderboard.leaderboard'),
