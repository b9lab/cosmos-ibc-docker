...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.CheckersPacketData
	...
	case *types.CheckersPacketData_ScorePacket:
		packetAck, err := am.keeper.OnRecvScorePacket(ctx, modulePacket, *packet.ScorePacket)
		if err != nil {
...
func (am AppModule) OnAcknowledgementPacket(
	...
	case *types.CheckersPacketData_ScorePacket:
		err := am.keeper.OnAcknowledgementScorePacket(ctx, modulePacket, *packet.ScorePacket, ack)
		if err != nil {
			return nil, err
		}
		eventType = types.EventTypeScorePacket
	default:
		errMsg := fmt.Sprintf("unrecognized %s packet type: %T", types.ModuleName, packet)
...
func (am AppModule) OnTimeoutPacket(
	...
	case *types.CheckersPacketData_ScorePacket:
		err := am.keeper.OnTimeoutScorePacket(ctx, modulePacket, *packet.ScorePacket)
		if err != nil {
			return nil, err
		}
	default:
