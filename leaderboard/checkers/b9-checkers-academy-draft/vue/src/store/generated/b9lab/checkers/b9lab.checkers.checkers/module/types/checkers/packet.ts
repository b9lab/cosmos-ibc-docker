...
export const CheckersPacketData = {
  encode(message: CheckersPacketData, writer: Writer = Writer.create()): Writer {
  ...
  toJSON(message: CheckersPacketData): unknown {
    ...
    message.scorePacket !== undefined && (obj.scorePacket = message.scorePacket ? ScorePacketData.toJSON(message.scorePacket) : undefined)
    return obj
  },
...
const baseScorePacketData: object = { playerAddress: '', wonCount: 0, DateAdded: '' }
