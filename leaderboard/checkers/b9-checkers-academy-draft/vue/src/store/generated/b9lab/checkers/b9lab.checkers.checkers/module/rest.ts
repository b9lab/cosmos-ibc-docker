...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/b9lab/checkers/checkers/canPlayMove
   */
  queryCanPlayMove = (
    ...
    this.request<CheckersQueryCanPlayMoveResponse, RpcStatus>({
      path: `/b9lab/checkers/checkers/canPlayMove`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/b9lab/checkers/checkers/playerInfo
   */
  queryPlayerInfoAll = (
    query?: {
    ...
    this.request<CheckersQueryAllPlayerInfoResponse, RpcStatus>({
      path: `/b9lab/checkers/checkers/playerInfo`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
