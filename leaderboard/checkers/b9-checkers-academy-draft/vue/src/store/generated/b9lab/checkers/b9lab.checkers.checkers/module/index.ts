...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgRejectGame: (data: MsgRejectGame): EncodeObject => ({ typeUrl: "/b9lab.checkers.checkers.MsgRejectGame", value: MsgRejectGame.fromPartial( data ) }),
    ...
    msgSendScore: (data: MsgSendScore): EncodeObject => ({ typeUrl: "/b9lab.checkers.checkers.MsgSendScore", value: MsgSendScore.fromPartial( data ) }),
