...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryBoardAll = (
    ...
    this.request<LeaderboardQueryAllBoardResponse, RpcStatus>({
   ...
   */
  queryBoard = (index: string, params: RequestParams = {}) =>
    this.request<LeaderboardQueryGetBoardResponse, RpcStatus>({
      path: `/cosmonaut/leaderboard/leaderboard/board/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryPlayerInfoAll = (
    ...
    this.request<LeaderboardQueryAllPlayerInfoResponse, RpcStatus>({
      path: `/cosmonaut/leaderboard/leaderboard/playerInfo`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryPlayerInfo = (index: string, params: RequestParams = {}) =>
    this.request<LeaderboardQueryGetPlayerInfoResponse, RpcStatus>({
      path: `/cosmonaut/leaderboard/leaderboard/playerInfo/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
