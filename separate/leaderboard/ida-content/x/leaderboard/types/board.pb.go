...
func (m *Board) GetPlayer() []*PlayerInfo {
	if m != nil {
		return m.Player
	}
	return nil
...
var fileDescriptor_34f23611952586d8 = []byte{
	...
	,
}
...
func (m *Board) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.GameID) > 0 {
		...
		i = encodeVarintBoard(dAtA, i, uint64(len(m.GameID)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Player) > 0 {
